...
| RQ-026 | Platform §§26–27: test strategy, CI/CD, performance/security/failure/restore tests | PARTIAL | Python tests, PostgreSQL integration/restore drill, `Dockerfile`, `.github/workflows/verify.yml`, dashboard smoke and Playwright/Axe | Cycle 232 exact-main run `33400243819` passes 460 tests, 143 restore checks, the 117/117 ratchet and a 47-file zero-error slice, including the checked qlib static-review regression. Load/performance, manual assistive-tech, registry-native OCI signing and production deployment testing remain incomplete. |
...
| RQ-028 | Upstream §§36.1–36.4: isolated repository research | PARTIAL | `C:/Users/omerf/upstream-research/repositories`, `docs/upstream/*`, `identity_activity_refresh_2026-08-31.json` | Cycle 231 records all 16 local pins, branch heads, remote activity and worktree states without execution: 12 recorded remote branches advanced, four remain current, and the pre-existing partial Windows checkout remains isolated. Cycles 232–233 statically re-read current qlib and FinRL-Trading pins without execution; no updated pin is reviewed. |
| RQ-029 | Upstream §§36.5–36.8: license/security/SBOM/adoption gates | PARTIAL | `docs/upstream/LICENSE_MATRIX.md`, `SECURITY_FINDINGS.md`, `ADOPTION_DECISIONS.md`, `QLIB_STATIC_REVIEW_2026-08-31.md`, `finrl_static_review_2026-08-31.json` | Cycle 232 supplies restricted qlib SAST, secret and direct-declaration SBOM evidence, finding 18 high SAST signals and no exact dependency pins. Cycle 233 records FinRL-Trading's incomplete SAST scan, zero secret findings and 25 unpinned declarations. Neither is a resolved SCA, container, malicious-package or legal review; no upstream dependency is approved. |
...
| RQ-028 | PARTIAL | Sixteen isolated local upstream clones, static manifest inventory, Cycle 231 identity/activity snapshot and Cycle 232 frozen qlib review. | All 16 local pins, remote heads, activity timestamps and clean/partial worktree state were re-read without execution; Cycle 232 then scanned only qlib's current local pin without changing it. | No advanced remote head is pinned/reviewed and complete per-repository security review is not complete. | RQ-029. | None for read-only refresh. | Complete another immutable candidate's restricted review; do not fetch advanced heads. | Every candidate has reproducible identity, provenance, maintenance and architecture records. |
| RQ-029 | PARTIAL | Static license, security and adoption-decision records; qlib's restricted SAST/secret/direct-SBOM record; all candidates remain reference-only. | Qlib's Cycle 232 review recorded an MIT root license, zero secret findings, 18 high/50 medium/409 low Bandit signals and a 23-component unpinned direct-declaration SBOM, then deferred adoption. | No resolved SCA, transitive SBOM, container/malicious-package scan, source-level triage or legal review for qlib; all other candidates remain without a focused full record. | RQ-028; gates RQ-030. | Approved isolated environment and legal review are required before any adoption. | Triage qlib's static findings only after such approval; meanwhile scan another immutable candidate without execution. | Each candidate has reviewed license, SBOM, security findings and explicit accept/reject decision. |
