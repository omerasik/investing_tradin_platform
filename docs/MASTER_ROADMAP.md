...
| RQ-026 | Platform §§26–27: test strategy, CI/CD, performance/security/failure/restore tests | PARTIAL | Python tests, PostgreSQL integration/restore drill, `Dockerfile`, `.github/workflows/verify.yml`, dashboard smoke and Playwright/Axe | Cycle 235 exact-main run `33435806249` passes 463 tests, 143 restore checks, the 117/117 ratchet and a 47-file zero-error slice, including checked qlib, FinRL-Trading, NautilusTrader and VectorBT static-review regressions. Load/performance, manual assistive-tech, registry-native OCI signing and production deployment testing remain incomplete. |
...
| RQ-028 | Upstream §§36.1–36.4: isolated repository research | PARTIAL | `C:/Users/omerf/upstream-research/repositories`, `docs/upstream/*`, `identity_activity_refresh_2026-08-31.json` | Cycle 231 records all 16 local pins, branch heads, remote activity and worktree states without execution: 12 recorded remote branches advanced, four remain current, and the pre-existing partial Windows checkout remains isolated. Cycles 232–235 statically re-read current qlib, FinRL-Trading, NautilusTrader and VectorBT pins without execution; no updated pin is reviewed. |
| RQ-029 | Upstream §§36.5–36.8: license/security/SBOM/adoption gates | PARTIAL | `docs/upstream/LICENSE_MATRIX.md`, `SECURITY_FINDINGS.md`, `ADOPTION_DECISIONS.md`, `QLIB_STATIC_REVIEW_2026-08-31.md`, `finrl_static_review_2026-08-31.json`, `nautilus_static_review_2026-08-31.json`, `vectorbt_static_review_2026-08-31.json` | Cycles 232–235 supply restricted qlib, FinRL-Trading, NautilusTrader and VectorBT SAST/secret/dependency evidence. All remain reference-only: this is not a resolved SCA, container, malicious-package or legal review, and no upstream dependency is approved. |
...
| RQ-028 | PARTIAL | Sixteen isolated local upstream clones, static manifest inventory, Cycle 231 identity/activity snapshot and restricted qlib, FinRL-Trading, NautilusTrader and VectorBT reviews. | All 16 local pins, remote heads, activity timestamps and clean/partial worktree state were re-read without execution; Cycles 232–235 scanned only four current local pins without changing them. | No advanced remote head is pinned/reviewed and complete per-repository security review is not complete. | RQ-029. | None for read-only refresh. | Complete another immutable candidate's restricted review; do not fetch advanced heads. | Every candidate has reproducible identity, provenance, maintenance and architecture records. |
| RQ-029 | PARTIAL | Static license, security and adoption-decision records; restricted qlib, FinRL-Trading, NautilusTrader and VectorBT records; all candidates remain reference-only. | Cycles 232–235 recorded reproducible static license, secret, SAST and manifest evidence for four frozen pins, then deferred each candidate. | No resolved SCA, transitive SBOM, container/malicious-package scan, source-level triage or legal review for any candidate; most candidates remain without a focused record. | RQ-028; gates RQ-030. | Approved isolated environment and legal review are required before any adoption. | Triage findings only after such approval; meanwhile scan another immutable candidate without execution. | Each candidate has reviewed license, SBOM, security findings and explicit accept/reject decision. |
