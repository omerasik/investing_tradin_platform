...
- Status: IMPLEMENTED/TESTED_LOCAL; PostgreSQL CI is required before this bounded slice is VERIFIED. Overall composition cutover remains PARTIAL until the `MUST_MIGRATE` rows are replaced.
