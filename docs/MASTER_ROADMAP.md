...
| RQ-026 | Platform §§26–27: test strategy, CI/CD, performance/security/failure/restore tests | PARTIAL | Python tests, PostgreSQL integration/restore drill, `Dockerfile`, `.github/workflows/verify.yml`, dashboard smoke and Playwright/Axe | Cycle 234 exact-main run `33403812161` passes 462 tests, 143 restore checks, the 117/117 ratchet and a 47-file zero-error slice, including checked FinRL and Nautilus static-review regressions. Load/performance, manual assistive-tech, registry-native OCI signing and production deployment testing remain incomplete. |
...
| RQ-028 | Upstream §§36.1–36.4: isolated repository research | PARTIAL | `C:/Users/omerf/upstream-research/repositories`, `docs/upstream/*`, `identity_activity_refresh_2026-08-31.json` | Cycle 231 records all 16 local pins, branch heads, remote activity and worktree states without execution: 12 recorded remote branches advanced, four remain current, and the pre-existing partial Windows checkout remains isolated. Cycles 232–234 statically re-read current qlib, FinRL-Trading and NautilusTrader pins without execution; no updated pin is reviewed. |
| RQ-029 | Upstream §§36.5–36.8: license/security/SBOM/adoption gates | PARTIAL | `docs/upstream/LICENSE_MATRIX.md`, `SECURITY_FINDINGS.md`, `ADOPTION_DECISIONS.md`, `QLIB_STATIC_REVIEW_2026-08-31.md`, `finrl_static_review_2026-08-31.json`, `nautilus_static_review_2026-08-31.json` | Cycles 232–234 supply restricted qlib, FinRL-Trading and NautilusTrader SAST/secret/dependency evidence. All remain reference-only: this is not a resolved SCA, container, malicious-package or legal review, and no upstream dependency is approved. |
