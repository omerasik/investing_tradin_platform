...
CRITICAL_TABLES = (
    ...
    "research_retrieval_policy_versions",
    "internal_research_evidence_chunks",
    "research_retrieval_reports",
    "research_retrieval_results",
    "agent_answer_evaluation_policy_versions",
    "agent_answer_evaluation_reports",
    "agent_answer_claim_evaluations",
    "model_monitoring_policy_versions",
    "model_monitoring_reports",
    "model_explanation_sensitivity_scenarios",
    "model_degradation_observations",
    "kill_switch_events",
    "reconciliations",
