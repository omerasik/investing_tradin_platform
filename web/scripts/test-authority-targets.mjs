...
const requested = [
  ...
  `/operator-dashboard/chart-series/${"a".repeat(64)}?max_points=400&instrument=${encodeURIComponent("CRYPTO:BYBIT:BTCUSDT:PERP")}`,
...
const refused = [
  ...
  "/operator-dashboard/chart-series?limit=5",
  `/operator-dashboard/chart-series/${"A".repeat(64)}`,
  `/operator-dashboard/chart-series/${"a".repeat(63)}`,
  `/operator-dashboard/chart-series/${"a".repeat(64)}?path=..`,
  "/research/backtests",
  "/paper-oms/orders/x",
